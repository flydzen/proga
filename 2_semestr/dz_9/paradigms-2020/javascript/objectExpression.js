...
function makeOperation(cou_, ch_, eval_, diff_, simpl_) {
    function Oper(...args){
...
const constantCreator = function (ch_ = '', defValue = 0){
    ...
    Elem.prototype.prefix = function () { return this.ch? this.ch :"" + this.f; };
    Elem.prototype.postfix = function () { return this.ch? this.ch :"" + this.f; };
